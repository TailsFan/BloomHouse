...
const achievements = [
  { icon: <span className="text-2xl">❤️</span>, title: "5000+", description: "Счастливых клиентов" },
  { icon: <span className="text-2xl">🏆</span>, title: "7 лет", description: "На рынке цветов" },
  { icon: <span className="text-2xl">👥</span>, title: "20+", description: "Опытных флористов" },
  { icon: <span className="text-2xl">🚚</span>, title: "2 часа", description: "Средняя доставка" }
];
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {achievements.map((achievement, index) => (
                <div key={index} className="bg-white border border-border rounded-lg p-4 text-center">
